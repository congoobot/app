...
module.exports = {
    ...
    enabled: true,
    guildOnly: true,
    aliases: ["yta2","yt-atlat2","ytatlat2"],
...
//KADEMELER
member.roles.add("verilecek 2.yetki kademesi");
member.roles.remove("alınacak 1.yetki kademeleri"); //1. Yetkili Kademesi

//YETKİLER
member.roles.add("verilecek 2.yetki kademesi"); //1. Yetki     
