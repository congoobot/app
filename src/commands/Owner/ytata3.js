...
module.exports = {
    ...
    enabled: true,
    guildOnly: true,
    aliases: ["yta3","yt-atlat3","ytatlat3"],
...
//KADEMELER
member.roles.add("verilecek 2.yetki kademeleri");
member.roles.remove("alınacak 2.yetki kademeleri"); //1. Yetkili Kademesi

//YETKİLER
member.roles.add("verilecek 2.yetki kademeleri"); //1. Yetki     
